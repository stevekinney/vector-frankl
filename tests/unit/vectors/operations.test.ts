...
describe('VectorOperations', () => {
  ...
  describe('dotProduct', () => {
    ...
    test('should throw error for dimension mismatch', () => {
      ...
      expect(() => VectorOperations.dotProduct(vectorA, vectorB)).toThrow(DimensionMismatchError);
    });
  });
  ...
  describe('statistical operations', () => {
    ...
    test('should throw error for empty vector array', () => {
      expect(() => VectorOperations.mean([])).toThrow('Cannot calculate mean of empty vector array');
      expect(() => VectorOperations.variance([])).toThrow('Cannot calculate variance of empty vector array');
    });
  });
