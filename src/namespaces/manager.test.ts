...
describe('NamespaceManager', () => {
  ...
  describe('initialization', () => {
    it('should initialize successfully', async () => {
      const newManager = new NamespaceManager('test-init', undefined, {
        timeSource: clock,
      });
  ...
  describe('createNamespace', () => {
    ...
    it('should reject duplicate namespace names', async () => {
      ...
      expect(manager.createNamespace('duplicate', { dimension: 200 })).rejects.toThrow(
    ...
    it('should rollback on failure', async () => {
      ...
      expect(manager.createNamespace('fail-test', config)).rejects.toThrow();
  ...
  describe('getNamespace', () => {
    ...
    it('should throw for non-existent namespace', async () => {
      expect(manager.getNamespace('does-not-exist')).rejects.toThrow(
  ...
  describe('deleteAll', () => {
    it('should delete all namespaces and registry', async () => {
      ...
      const newManager = new NamespaceManager(testDbName, undefined, {
        timeSource: clock,
      });
